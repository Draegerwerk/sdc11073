...
class ContainerBase:
    ...
    def mk_node(self, tag: QName, ns_helper: NamespaceHelper, set_xsi_type: bool = False) -> Element:
    ...
    def update_node(self, node: Element,
                    ...
                    set_xsi_type: bool = False) -> Element:
    ...
    def update_from_node(self, node: Element):
