...
EntityTypeProtocol = EntityProtocol | MultiStateEntityProtocol
...
class EntityGetterProtocol(Protocol):  # pragma: no cover
    ...
    def by_node_type(self, node_type: QName) -> Sequence[EntityTypeProtocol]:
        """Return all entities with given node type."""
        ...

    def by_parent_handle(self, parent_handle: str | None) -> Sequence[EntityTypeProtocol]:
...
class ProviderEntityGetterProtocol(EntityGetterProtocol):  # pragma: no cover
    ...
    def new_entity(self, node_type: QName, handle: str, parent_handle: str | None) -> EntityTypeProtocol:
        """Create an entity."""
