...
class TestMdib(unittest.TestCase):
    ...
    def test_selectDescriptors(self):
        ...
        device_mdib_container = mdib.DeviceMdibContainer.from_mdib_file(os.path.join(mdibFolder, '70041_MDIB_Final.xml'))
    ...
    def test_mdib_tns(self):
        ...
        device_mdib_container = mdib.DeviceMdibContainer.from_mdib_file(os.path.join(os.path.dirname(__file__), 'mdib_tns.xml'))
