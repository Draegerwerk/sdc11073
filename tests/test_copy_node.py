...
from sdc11073.xml_types.xml_structure import copy_node, copy_node_wo_parent


class TestCopyNode(unittest.TestCase):
    """Test for methods copy_node and copy_node_wo_parent."""
...
<ns0:Envelope xmlns:ns0="http://www.w3.org/2003/05/soap-envelope">
    ...
    def setUp(self) -> None:
        self.xml_to_be_tested = [etree_.fromstring(raw_xml)[1] for raw_xml in self.xml_to_be_parsed]

    def _compare_nodes(self, expected, actual):
