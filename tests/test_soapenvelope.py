   ...
   <wsx:Metadata>
     <wsx:MetadataSection Dialect="http://docs.oasis-open.org/ws-dd/ns/dpws/2009/01/Relationship">
      <dpws:Relationship Type="http://docs.oasis-open.org/ws-dd/ns/dpws/2009/01/host">
        ...
        self.assertEqual(env.hosted['http://printer.example.org/imaging/PrintService'].endpointReferences[0].address,
                         'http://172.30.184.244/print')
        self.assertEqual(env.hosted['http://printer.example.org/imaging/PrintService'].endpointReferences[1].address,
                         'http://[fdaa:23]/print1')
        self.assertEqual(env.hosted['http://printer.example.org/imaging/PrintService'].types[0],
                         'img:PrintBasicPortType')
        self.assertEqual(env.hosted['http://printer.example.org/imaging/PrintService'].types[1],
                         'img:PrintAdvancedPortType')
        self.assertEqual(env.hosted['http://printer.example.org/imaging/PrintService'].serviceId,
