...
class TestIsoDate(unittest.TestCase):
    ...
    def test_durationString(self):
        self.assertEqual('P0Y0M0DT0H0M1S', durationString(1))
        self.assertEqual('P0Y0M0DT0H1M0S', durationString(60))
        self.assertEqual('P0Y0M0DT0H1M1S', durationString(61))
        ...
        self.assertEqual('P0Y0M0DT0H0M0.1S', durationString(0.1))
